...
/**
 * 经典上拉底部组件
 * Created by SCWANG on 2020
 */

public class ClassicsFooter1 extends LinearLayout implements RefreshFooter {

    private static final String REFRESH_BOTTOM_PULLUP = "";
    private static final String REFRESH_BOTTOM_RELEASE = "";
    private static final String REFRESH_BOTTOM_LOADING = "";
    ...
    public ClassicsFooter1(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs, 0);
    }

    public ClassicsFooter1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ClassicsFooter1 setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }
    public ClassicsFooter1 setAccentColor(int accentColor) {
